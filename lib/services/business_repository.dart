  ...
  Future<void> saveVenueProfile(BusinessVenueProfile profile, {String? venueId}) async {
    ...
    try {
      await client.from('venues').update({
        ...
        'hours_label': profile.openingHours.formatHoursLabel(),
        'website_url': profile.websiteUrl.isEmpty ? null : profile.websiteUrl,
        'instagram_url': profile.instagramUrl.isEmpty ? null : profile.instagramUrl,
        'facebook_url': profile.facebookUrl.isEmpty ? null : profile.facebookUrl,
        'tiktok_url': profile.tiktokUrl.isEmpty ? null : profile.tiktokUrl,
        'twitter_url': profile.twitterUrl.isEmpty ? null : profile.twitterUrl,
